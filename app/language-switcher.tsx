...
const thToEn: Record<string, string> = {
  ...
  'เรียนภาษาอังกฤษ':'English courses','พร้อมใช้ชีวิตจริง':'and experience life','ที่ Cambridge':'in Cambridge','สัมผัสบรรยากาศเมืองมหาวิทยาลัยชั้นนำ เรียนภาษา ทำกิจกรรม และพักกับ Host Family อย่างปลอดภัย':'Study in a world-class university city, join activities and stay safely with a host family.','2-3 สัปดาห์':'2-3 weeks','เรียน 30 ชั่วโมง':'30 study hours',
